...
As we can see, the doubleing of throws does not do a whole lot for the model, this is because we enter an area of dimishing returnes, where each new case gets a smaller and smaller impact, due to the large number of previous trials.
